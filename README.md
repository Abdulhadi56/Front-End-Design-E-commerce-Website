...
<footer class="footer">
  <div class="footer-content">
    ...
    <div class="footer-columns">
      ...
      <div>
        <h4>Get app</h4>
        <img src="appstore.jpeg" alt="App Store" class="app-link">
        <img src="googleplay.jpeg" alt="Google Play" class="app-link">
      </div>
    </div>
  </div>
...
/* Responsive for recommended items */
@media (max-width: 1024px) {
  .recommended-grid {
    grid-template-columns: repeat(4, 1fr);
  }
...
/*myWeb2.html CSS Code has 'myStyle2.css' and 'mySTyle3.css' files */


//code for myWeb2.html
...
/*myWeb5.html CSS Code has 'mySTyle3.css' files */

//code for myWeb3.html
* {
  box-sizing: border-box;
  margin: 0;
  padding: 0;
...
/*myWeb4.html CSS Code has 'myStyle2.css' and 'mySTyle3.css' files */

//code for myWeb4.html
.filters-bar{
    background-color: #fff;
    width: 1100px;
    height: 40px;
...
/*myWeb5.html CSS Code has 'myStyle2.css' and 'mySTyle3.css' files */   --> myStyle


//code for myWeb5.html
.cart-page {
  display: flex;
  justify-content: space-between;
}
